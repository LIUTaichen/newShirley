...
describe('Service Tests', () => {
    ...
    describe('PrestartCheckQuestionListItem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrestartCheckQuestionListItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prestart-check-question-list-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PrestartCheckQuestionListItem', () => {
