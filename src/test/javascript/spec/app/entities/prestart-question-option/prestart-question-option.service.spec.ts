...
describe('Service Tests', () => {
    ...
    describe('PrestartQuestionOption Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrestartQuestionOptionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prestart-question-options';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PrestartQuestionOption', () => {
