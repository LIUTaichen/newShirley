...
describe('Service Tests', () => {
    ...
    describe('PrestartCheckConfig Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrestartCheckConfigService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prestart-check-configs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PrestartCheckConfig', () => {
