...
describe('Service Tests', () => {
    ...
    describe('MaintenanceContractor Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MaintenanceContractorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/maintenance-contractors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MaintenanceContractor', () => {
