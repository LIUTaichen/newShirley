...
describe('Service Tests', () => {
    ...
    describe('WeeklyNiggleSnapshot Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(WeeklyNiggleSnapshotService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/weekly-niggle-snapshots';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WeeklyNiggleSnapshot', () => {
