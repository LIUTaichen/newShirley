...
describe('Service Tests', () => {
    ...
    describe('PrestartCheckResponse Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrestartCheckResponseService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prestart-check-responses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PrestartCheckResponse', () => {
