...
public class NiggleResourceIntTest {
    ...
    private static final Priority DEFAULT_PRIORITY = Priority.LEVEL1;
    private static final Priority UPDATED_PRIORITY = Priority.LEVEL2;
    ...
    public void createNiggle() throws Exception {
        ...
        assertThat(testNiggle.getDateUpdated()).isEqualTo(DEFAULT_DATE_UPDATED);
    ...
    public void updateNiggle() throws Exception {
        ...
        assertThat(testNiggle.getDateUpdated()).isEqualTo(UPDATED_DATE_UPDATED);
